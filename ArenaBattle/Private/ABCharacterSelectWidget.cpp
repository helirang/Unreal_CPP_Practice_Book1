...
void UABCharacterSelectWidget::NativeConstruct()
{
	...
	PreButton = Cast<UButton>(GetWidgetFromName(TEXT("btnPrev")));
	ABCHECK(nullptr != PreButton);
	...
	PreButton->OnClicked.AddDynamic(this, &UABCharacterSelectWidget::OnPrevClicked);
